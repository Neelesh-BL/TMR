...
log = logger.logger_init('training_tmr')
...
class TrainingModel:
    ...
    def __init__(self) -> None:
        try:
            self.training_data_df = pd.read_csv('/home/hp/Desktop/TMR-EDA/Data/pract_part_80.csv')
    ...
    def preprocessing(self):
        ...
        try:
           ...
           # Dropping all those rows which have any value as null
            ...
            'RFP Tech Ability','RFP Last TRACK Score','Trial Techability Score','Practice Head','TechCategory'])

            # Replacing the practice head names to Sunil and Ashish if Sunil Patil, Ashish Vishwakarma are present
            self.training_data_df.loc[self.training_data_df["Practice Head"] == "Sunil Patil", "Practice Head"] = "Sunil"
            self.training_data_df.loc[self.training_data_df["Practice Head"] == "Ashish Vishwakarma", "Practice Head"] = "Ashish"
